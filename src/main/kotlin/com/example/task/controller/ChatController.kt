...
import com.example.task.dto.chat.ChatHistoryResponse
import com.example.task.dto.chat.ChatRequest
import com.example.task.dto.chat.ChatResponse
...
class ChatController(
    ...
    fun getChatHistory(
        ...
        val response = ChatHistoryResponse.from(
            threadId = threadId,
    ...
    fun getChatHistoryPaged(
        ...
        val response = mapOf(
            "content" to chatPage.content.map { ChatResponse.from(it) },
    ...
    fun getMyChats(): ResponseEntity<List<ChatResponse>> {
        ...
        val response = chats.map { ChatResponse.from(it) }
        return ResponseEntity.ok(response)
    }
