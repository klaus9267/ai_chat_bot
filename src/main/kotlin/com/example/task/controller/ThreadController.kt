...
import com.example.task.application.ThreadService
import com.example.task.dto.thread.ThreadResponse
...
class ThreadController(
    ...
    fun getUserThreads(): ResponseEntity<List<ThreadResponse>> {
        ...
        val response = threads.map { ThreadResponse.from(it) }
    ...
    fun getThread(
        ...
        return ResponseEntity.ok(ThreadResponse.from(thread))
    }
